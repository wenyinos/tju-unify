...
### 五、团队贡献
- 高灿：二手交易市场本地接口的实现  **工作量：20%**
- 曾意：agent基础框架搭建，高级检索部分与智能体streamlit简易前端测试 **工作量：20%**
- 杨晓越：天大数据文件收集与汇总，PDF处理，向量化入库（基础检索部分） **工作量：20%**
- 戴茗静：新闻推送的本地接口实现 **工作量：20%**
- 贾思韵：agent的react中间件 **工作量：20%**
